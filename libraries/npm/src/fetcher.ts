...
async function fetch_wrapper(url: string, properties: any) {
    ...
    if (credsStatus.fetch_properties) {
        properties = { method: properties.method, body: properties.body, ...credsStatus.fetch_properties };
    }
