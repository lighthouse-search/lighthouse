...
export default function Search_list() {
    ...
    return (
        <Home1 header={["Index", "Search"]} header_children={<Button_with_icon href="/index/add-url">Add URLs</Button_with_icon>} full_background={true} className="home_padding row_gap_8">
            <Search_Input1/>
            <div className="column scrollY row_gap_8">
                <p>Top indexed sites</p>
                {urls_ul}
            </div>
        </Home1>
    )
