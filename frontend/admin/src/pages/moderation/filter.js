...
export default function Moderation_filter() {
    ...
    return (
        <Home1 header={["Moderation", "Filter"]} header_children={<Button_with_icon href="/moderation/filter/create">Create filter</Button_with_icon>} full_background={true} className="home_padding row_gap_8">
            <Search_Input1/>
